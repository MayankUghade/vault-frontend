...
export default function App() {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    alert(`Welcome to the Vault, ${username}! (This is a demo)`);
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-emerald-500/30">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 px-6 py-8 flex justify-between items-center max-w-7xl mx-auto left-1/2 -translate-x-1/2 bg-black">
        ...
        <div className="flex items-center gap-8">
          <button 
            ...
            className="px-6 py-2 bg-white text-black font-semibold rounded-full hover:bg-emerald-400 transition-colors duration-300"
          >
            Sign Up
          </button>
        </div>
      ...
      <main className="pt-32 px-6 max-w-7xl mx-auto">
        <section className="flex flex-col items-center text-center py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              onClick={() => setIsSignUpOpen(true)}
              className="px-8 py-4 bg-emerald-500 text-black font-bold rounded-2xl flex items-center gap-2 hover:bg-emerald-400 transition-all hover:scale-105 glow-emerald"
            >
        ...
        <section className="py-24 bg-emerald-500/5 rounded-[40px] px-8 md:px-20 border border-emerald-500/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-xl">
              ...
              <button className="px-8 py-4 bg-white text-black font-bold rounded-2xl hover:bg-emerald-400 transition-all">
      ...
      <footer className="py-20 px-6 border-t border-white/5 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-4">
            <button className="p-2 rounded-full glass hover:text-emerald-500 transition-colors">
